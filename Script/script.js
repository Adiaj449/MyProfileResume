...
function createHeader(params) {
    ...
    col2.innerHTML ="<a href="+"https://github.com/Adiaj449"+"><span class="+"menu"+">Github </span></a><a target="+"_blank"+"+ href="+"https://www.linkedin.com/in/ajinkya-algonda-4b9b3180"+"><span class="+"menu"+">LinkedIn </span></a><a target="+"_blank"+" href="+"#"+"><span class="+"menu"+">Projects</span></a>";
